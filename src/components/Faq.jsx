...
const Faq = () => {
  ...
  return (
    <div className="w-full p-4 flex flex-col md:flex-row gap-8 px-8">
      <div className="md:w-[30%] md:p-8 text-center">
        <h2>FAQs</h2>
        <p>
        ...
        {faq.map((item, index) => (
          <div key={index} className="border-t border-gray-300 py-2">
            ...
            >
              ...
              <span
                className={activeIndex === index ? "rotate-0" : "rotate-180"}
              >
            ...
            >
              ...
              <p className="mt-2 px-2">{item.answer}</p>
              {/* </div> */}
            </div>
          </div>
        ))}
